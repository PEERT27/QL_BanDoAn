...
public class DetailedDailyModel {
    ...
    public DetailedDailyModel(String id_thucan, int image, String name, String description, String rating, String price, String timing, String id_loaithucan, String id_featured) {
